...
{    
  ...
  tempUnion.asFloat = read_adc(3);   
  Serial.write(tempUnion.asByte[0]);
  Serial.write(tempUnion.asByte[1]);
  Serial.write(tempUnion.asByte[2]);
  Serial.write(tempUnion.asByte[3]);

  
  tempUnion.asFloat = read_adc(4);
  Serial.write(tempUnion.asByte[0]);
  Serial.write(tempUnion.asByte[1]);
  Serial.write(tempUnion.asByte[2]);
  Serial.write(tempUnion.asByte[3]);
  
  tempUnion.asFloat = read_adc(5);   
  Serial.write(tempUnion.asByte[0]);
  Serial.write(tempUnion.asByte[1]);
  Serial.write(tempUnion.asByte[2]);
  Serial.write(tempUnion.asByte[3]);
  ...
  tempUnion.asFloat = ToDeg(roll);   
  Serial.write(tempUnion.asByte[0]);
  Serial.write(tempUnion.asByte[1]);
  Serial.write(tempUnion.asByte[2]);
  Serial.write(tempUnion.asByte[3]);

  tempUnion.asFloat = ToDeg(pitch);   
  Serial.write(tempUnion.asByte[0]);
  Serial.write(tempUnion.asByte[1]);
  Serial.write(tempUnion.asByte[2]);
  Serial.write(tempUnion.asByte[3]);
 
  tempUnion.asFloat = ToDeg(yaw);   
  Serial.write(tempUnion.asByte[0]);
  Serial.write(tempUnion.asByte[1]);
  Serial.write(tempUnion.asByte[2]);
  Serial.write(tempUnion.asByte[3]);
